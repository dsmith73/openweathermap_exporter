...
// 4259418:5879400:4907985:4043416:1269843  
// Indianapolis, IN : Anchorage, AK : Rockton, IL : Guam : Hyderabad, India  
*/
	...
	go func() {
		...
		for {
			...
			case <-c:
				...
				w, err := owm.NewCurrent("F", "EN", cfg.APIKey, owm.WithHttpClient(client)) // (internal - OpenWeatherMap reference for fahrenheit) with English output
				if err != nil {
					errC <- err
					continue
				}
